// using this file we create the proto file
...
const (
	AccountService_PostAccoutn_FullMethodName = "/pb.AccountService/PostAccoutn"
...
type AccountServiceClient interface {
	PostAccoutn(ctx context.Context, in *PostAccountRequest, opts ...grpc.CallOption) (*PostAccountResponse, error)
...
func (c *accountServiceClient) PostAccoutn(ctx context.Context, in *PostAccountRequest, opts ...grpc.CallOption) (*PostAccountResponse, error) {
	out := new(PostAccountResponse)
	err := c.cc.Invoke(ctx, AccountService_PostAccoutn_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountServiceServer interface {
	PostAccoutn(context.Context, *PostAccountRequest) (*PostAccountResponse, error)
...
func (UnimplementedAccountServiceServer) PostAccoutn(context.Context, *PostAccountRequest) (*PostAccountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PostAccoutn not implemented")
}
...
func _AccountService_PostAccoutn_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PostAccountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).PostAccoutn(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountService_PostAccoutn_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).PostAccoutn(ctx, req.(*PostAccountRequest))
	}
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PostAccoutn",
			Handler:    _AccountService_PostAccoutn_Handler,
		},
		{
